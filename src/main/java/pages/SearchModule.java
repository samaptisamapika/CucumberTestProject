...
public class SearchModule {
    ...
    private By searchFilterDropDownButton = By.cssSelector(".rfs-select__button");
    ...
    public Boolean searchModuleElementIsVisible() {
        ...
        wait.until(ExpectedConditions.presenceOfNestedElementLocatedBy(searchResultsPage, By.cssSelector(".searchresult")));
    ...
    public void selectDropDownValue(String filterValue) {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(searchFilterDropDownButton));
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(searchFilterDropDownButton));
